                  ...
                  <table style="width: 90%" class="table table-bordered" align="center">
                    <thead>
                     <tr>
                         ...
                         <th style="color:midnightblue"><strong>Topics</strong></th>
...
<s:iterator value="course_list"> 
        ...
        <tr style="width: 50%">
                ...
                <td><s:property value="time_remaining"/></td>
                 <td> <a class="btn btn-primary" href='ViewEnrolledCourseTopic?cid=<s:property value="courseid"/>'> See Topics</a></td>
